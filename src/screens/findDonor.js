...
const people = [
  ...
  {
  var city = ref.target.value
  alert(city)
   }
  const getValueFromBloodGroup = (ref) =>
  {
  var bloodGroup = ref.target.value
  alert(bloodGroup)
   }
...
<select className="form-control" onChange={getValueFromCity.bind(this)}>
    ...
    <option value="" disabled style = {{fontWeight : 'bold'}}>Sindh Cities</option>
    ...
    <option value="" disabled style = {{fontWeight : 'bold'}}>Khyber Cities</option>
    ...
    <option value="" disabled style = {{fontWeight : 'bold'}}>Balochistan Cities</option>
...
<div className="col-sm-6">
<div className="form-group">
 <select className="form-control" onChange={getValueFromBloodGroup.bind(this)} >
